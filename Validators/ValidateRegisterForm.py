...
class ValidateRegisterForm:
    ...
    def validate_appointment_time(self, value):
        if str(value) != 'Eπέλεξε ραντεβού':
            return True
        else:
            return False

    def validate_form(self, fname, lname, mobile, city, email, start_time=None):
        ...
        if start_time is not None and not self.validate_appointment_time(start_time):
            return {'status': False, 'error_field': 'start_time'}
